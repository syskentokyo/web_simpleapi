...
for($i=0;$i<10;$i++) {
    ...
    $locationInfo->name = substr(str_shuffle('abcdefghijklmnopqrstuvwxyz'), 0, 8);
    $locationInfo->latitude =35+(0.000001* rand(-500000, 1000000));
    $locationInfo->longitude =139+(0.000001* rand(-1000000, 1000000));
